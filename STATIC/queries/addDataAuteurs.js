...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Swal.fire({
        ...
        <div class="container-title">
            <div class="swal2-title">Ajouter un nouvel auteur</div>
        </div>
        <div class="container-tabs">
            <div class="tabs">
                <div class="tabs-toggle">
                 
                    <div class="tab active" onclick="showTabContent(0)">Auteur</div>
                </div>
        ...
        <div class="tab-content-container">
            <div class="tab-content active" id="tab-1">
                <div class="form-group">
                    <label for="authorName" class="label-name">Nom de l'auteur <span class="required-field">*</span></label>
                    <input type="text" id="authorName" class="inputField100" name="authorName" required>
                </div>
            </div>
                <div>
