...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Swal.fire({
        ...
        <div class="container-title">
            <div class="swal2-title">Ajouter une nouvelle édition</div>
        </div>
        ...
        <div class="tab-content-container">
            <div class="tab-content active" id="tab-1">
                <div class="form-group">
                    <label for="publisherName" class="label-name">Nom de l'édition <span class="required-field">*</span></label>
                    <input type="text" id="publisherName" class="inputField100" name="publisherName" required>
                </div>
            </div>
            <div class="tab-content" id="tab-2">
                ...
                <div class="form-group inputFieldF70">
                        ...
                        <input type="text" class="" id="recapPublisherName" readonly>
                </div>
                <div class="form-group inputFieldF30">
                        <label>Code éditeur</label>
                        <input type="text" class="" id="publisherCode" readonly>
                </div>
                </div>   
            </div>
                <div>
